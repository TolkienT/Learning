...
namespace WebApi.Common.Helpers
{
    public class JwtHelper
    {
        ...
        {
            string keyStr = Appsettings.GetApp(new string[] { "Authorization", "Jwt", "Key" });
            int expiresTime = int.Parse(Appsettings.GetApp(new string[] { "Authorization", "Jwt", "ExpiresTime" }));
